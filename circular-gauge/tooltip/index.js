        ...
        tooltipRender: function (args) {
            ...
            if (args.pointer) {
				...
				if (circulargauge.theme.toLowerCase() === 'highcontrast') {
                    ...
                    ';background-color:black"><img src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/' + imageName + '.png"/><div class="des" style="color: ' +
                    textColor + '"><span>${value} MPH</span></div></div>';
                } else {
                    args.tooltip.template = '<div id="templateWrap" style="border:2px solid ' + borderColor +
                    '"><img src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/' + imageName + '.png"/><div class="des" style="color: ' +
                ...
                if (circulargauge.theme.toLowerCase() === 'highcontrast') {
                    ...
                    textColor + ';background-color:black"><img src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/' + imageName +
                    '.png"/> <span>' + start + ' - ' + end + ' MPH  </span> </div>';
                } else {
                    args.tooltip.rangeSettings.template = '<div id=templateWrap style="padding:5px;border:2px solid' + borderColor + ';color: ' +
                    borderColor + '"><img src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/' + imageName +
                    '.png"/> <span>' + start + ' - ' + end + ' MPH  </span> </div>';
                }
