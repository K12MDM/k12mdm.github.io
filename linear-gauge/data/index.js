...
function firstGauge() {
    var gauge1 = new ej.lineargauge.LinearGauge({
        ...
        annotations: [{
            ...
            {
                content: '<div id="running" style="width:100px;"><img style="height:25px;width:25px;float:left" src="//ej2.syncfusion.com/javascript/demos/src/linear-gauge' +
...
function secondGauge() {
    var gauge1 = new ej.lineargauge.LinearGauge({
        ...
        annotations: [{
                content: '<div id="cycle" style="width:100px;"><img style="height:25px;width:25px;float:left" src="//ej2.syncfusion.com/javascript/demos/src/linear-gauge' + '/images/Cycling.svg" /></span><p style="float:left;margin-left:10px;">Cycling</p></div>',
                axisIndex: 0,
                axisValue: 0,
                x: 50,
                y: -110,
...
function thirdGauge() {
    var gauge3 = new ej.lineargauge.LinearGauge({
        ...
        // custom code end
        annotations: [{
                content: '<div id="walk" style="width:100px;"><img style="height:25px;width:25px;float:left" src="//ej2.syncfusion.com/javascript/demos/src/' +
