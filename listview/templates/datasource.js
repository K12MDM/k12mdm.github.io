...
window.commonData = [
    ...
    { name: 'Margaret', imgUrl: '//ej2.syncfusion.com/javascript/demos/src/listview/images/margaret.png', id: '3' },
    { name: 'Steven', icon: 'S', id: '4' },
    { name: 'Laura', imgUrl: '//ej2.syncfusion.com/javascript/demos/src/listview/images/laura.png', id: '5' },
    { name: 'Robert', icon: 'R', id: '6' },
    { name: 'Michael', icon: 'M', id: '7' },
    { name: 'Albert', imgUrl: '//ej2.syncfusion.com/javascript/demos/src/listview/images/albert.png', id: '8' },
