                ...
                markerSettings: [
                    {
                        ...
                        width: 30,
                        visible: true,
                        template: '<div id="marker1"><img class="markerTemplate" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/weather-clear.png"/>' +
                    ...
                    },
                    {
                        ...
                        width: 30,
                        visible: true,
                        template: '<div id="marker1"><img class="markerTemplate" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/weather-clouds.png"/>' +
                            '<p>{{:Name}}:{{:Temperature}}°C</p></div>',
                        dataSource: [
                    ...
                    },
                    {
                        ...
                        width: 30,
                        visible: true,
                        template: '<div id="marker1"><img class="markerTemplate" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/weather-rain.png"/>' +
                            '<p>{{:Name}}:{{:Temperature}}°C</p></div>',
                        dataSource: [
